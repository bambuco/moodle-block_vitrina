...
$string['detailtemplatetype'] = 'Detail template';
$string['detailtemplatetype_help'] = 'Choose the template used on the course detail page. This is independent from the course card template.';
...
$string['includehiddencourses_help'] = 'If enabled, the block will also display courses that are hidden (not visible) if the user has access to them.';
...
$string['opendetailstarget'] = 'Open course detail in';
$string['opendetailstarget_blank'] = 'New window';
$string['opendetailstarget_help'] = 'Choose where to open the course detail page.';
...
$string['templatetype'] = 'Course card template';
$string['templatetype_help'] = 'Choose the template used for course cards in the catalog, the block, and related courses.';
